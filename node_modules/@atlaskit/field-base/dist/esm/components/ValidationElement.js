  ...
  _createClass(ValidationElement, [{
    ...
    value: function render() {
      if (!this.props.isDisabled && this.props.isInvalid) {
        return /*#__PURE__*/React.createElement(WarningIcon, null, /*#__PURE__*/React.createElement(Icon, {
          label: "warning"
        }));
      }

      return this.props.isLoading ? /*#__PURE__*/React.createElement(SpinnerParent, null, /*#__PURE__*/React.createElement(Spinner, {
        size: "small"
      })) : null;
    }
  }]);
